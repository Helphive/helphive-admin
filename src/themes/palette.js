...
export default function Palette(mode, presetColor, themeContrast) {
	...
	return createTheme({
		palette: {
			...
			text: {
				primary:
					mode === ThemeMode.DARK ? alpha(paletteColor.secondary.darker, 0.87) : paletteColor.secondary[800],
				secondary:
					mode === ThemeMode.DARK ? alpha(paletteColor.secondary.darker, 0.45) : paletteColor.secondary.main,
				disabled:
					mode === ThemeMode.DARK ? alpha(paletteColor.secondary.darker, 0.1) : paletteColor.secondary[400],
			},
			action: {
